            ...
            <b-row class="page-titles">
                ...
                <b-col cols="7">
                    <div class="d-flex justify-content-end align-items-center">
                        ...
                        <b-button @click="abrirModalVideo(1)" class="btn btn-info d-lg-block m-l-15" v-b-tooltip.hover title="Agrega un usuario a la plataforma"><i class="fa fa-plus-circle"></i> Agregar Usuario</b-button>
                    </div>                    
                </b-col>
            </b-row>
                        ...
                        <b-form-group>
                            <b-container fluid>
                                ...
                                <template v-slot:cell(acciones)="data">
                                    <b-button size="xs" variant="warning" title="Actualizar modelo" @click="abrirModalVideo(2, data.item)">
