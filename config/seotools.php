...
return [
    'meta'      => [
         ...
         */
        'defaults'       => [
            'title'        => "Las mejores escort de Concepción - ClubVip.cl", // set false to total remove
    ...
    'opengraph' => [
        ...
        'defaults' => [
            'title'       => 'Las mejores escort de Concepción - ClubVip.cl', // set false to total remove
            'description' => 'Las mejores escort, escorts, prostitutas, putas y damas de compañia de concepcion te esperan', // set false to total remove
            'url'         => 'https://www.clubvip.cl/', // Set null for using Url::current(), set false to total remove
            'type'        => false,
